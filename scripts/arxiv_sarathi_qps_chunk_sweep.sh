...
# chmod +x scripts/arxiv_sarathi_qps_chunk_sweep.sh
# ./scripts/arxiv_sarathi_qps_chunk_sweep.sh
...
# Point constants.py's DEFAULT_CONFIG_FILE at the arxiv yml, commenting out
...
for model_pair in "${MODELS[@]}"; do
    ...
    for qps in "${QPS_VALUES[@]}"; do
        ...
        for chunk_size in "${CHUNK_SIZES[@]}"; do
            RUN_NAME="arxiv_chunk_${chunk_size}_poison_${qps}_qps_${model_safe}"
