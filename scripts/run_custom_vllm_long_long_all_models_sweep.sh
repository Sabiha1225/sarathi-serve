...
# chmod +x scripts/run_custom_vllm_long_long_all_models_sweep.sh
# nohup ./scripts/run_custom_vllm_long_long_all_models_sweep.sh > log/custom_vllm_long_long_all_models_sweep.log 2>&1 &
# echo $! > log/custom_vllm_long_long_all_models_sweep.pid
# tail -f log/custom_vllm_long_long_all_models_sweep.log
