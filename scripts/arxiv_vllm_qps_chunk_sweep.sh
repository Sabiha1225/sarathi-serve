...
# chmod +x scripts/arxiv_vllm_qps_chunk_sweep.sh
# ./scripts/arxiv_vllm_qps_chunk_sweep.sh

# Use nohup so it continues after SSH/laptop disconnects:
# nohup ./scripts/arxiv_vllm_qps_chunk_sweep.sh \
#  > log/arxiv_vllm_qps_chunk_sweep.log 2>&1 &
...
SUMMARY="$OUTPUT_ROOT/arxiv_vllm_qps_sweep_summary.csv"
