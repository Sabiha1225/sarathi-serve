...
# chmod +x scripts/run_mistral_vllm_gpu_sweep.sh
# nohup ./scripts/run_mistral_vllm_gpu_sweep.sh \
#  > log/mistral_vllm_gpu_sweep.log 2>&1 &
...
for gpu_util in "${GPU_VALUES[@]}"; do
    ...
    RUN_NAME="arxiv_vllm_gpu_${gpu_label}_mistral"
