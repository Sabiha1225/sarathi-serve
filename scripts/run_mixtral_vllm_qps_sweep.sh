...
# chmod +x scripts/run_mixtral_vllm_qps_sweep.sh
# nohup ./scripts/run_mixtral_vllm_qps_sweep.sh \
#  > log/mixtral_vllm_qps_sweep.log 2>&1 &
...
for qps in "${QPS_VALUES[@]}"; do
    RUN_NAME="arxiv_vllm_poison_${qps}_qps_mixtral"
