...
# chmod +x scripts/sarathi_baseline_arxiv_qps_fixed_chunk_sweep.sh
# ./scripts/sarathi_baseline_arxiv_qps_fixed_chunk_sweep.sh

# nohup ./scripts/sarathi_baseline_arxiv_qps_fixed_chunk_sweep.sh \
#  > log/sarathi_baseline_arxiv_qps_fixed_chunk_sweep.log 2>&1 &


REPO="/home/sabiha/sarathi-serve"
MAIN="$REPO/sarathi/benchmark/main.py"
CONSTANTS_FILE="$REPO/sarathi/benchmark/constants.py"
OUTPUT_ROOT="$REPO/benchmark_output/sarathi_baseline_fixed_chunk"
TIME_FILE="$REPO/log/sarathi_baseline_fixed_chunk.txt"
LATEST_LOG="$REPO/log/sarathi_log.log"
SUMMARY="$OUTPUT_ROOT/sarathi_baseline_fixed_chunk_summary.csv"
