...
# python osdi-experiments/graphs/aggregate_arxiv_vllm_results.py

REPO = Path("/home/sabiha/sarathi-serve")
TIMES_CSV = Path("/home/sabiha/sarathi-serve/log/time_arxiv_vllm.csv")
OUTPUT_ROOT = REPO / "benchmark_output" / "arxiv"
OUT_CSV = REPO / "osdi-experiments" / "graphs" / "arxiv_vllm_full_results.csv"


def get_run_dir(model: str, qps: str) -> Path:
    run_name = f"arxiv_vllm_poison_{qps}_qps_{model}"
