...
# python osdi-experiments/graphs/aggregate_sharegpt_sarathi_results.py

REPO = Path("/home/sabiha/sarathi-serve")
TIMES_CSV = Path("/home/sabiha/sarathi-serve/log/time_sharegpt_sarathi.csv")
OUTPUT_ROOT = REPO / "benchmark_output" / "sharegpt"
OUT_CSV = REPO / "osdi-experiments" / "graphs" / "sharegpt_sarathi_full_results.csv"


def get_run_dir(model: str, chunk_size: str, qps: str) -> Path:
    run_name = f"sharegpt_chunk_{chunk_size}_poison_{qps}_qps_{model}"
